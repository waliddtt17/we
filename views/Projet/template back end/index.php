            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">                                                
                        <li>
                            <a href="index.php">
                                <i class="far fa-check-square"></i>Pubs </a>
                        </li>      
<li>
                            <a href="promo.php">
 ...
 <button class="btn btn-success" type="submit" name="done"> View Data </button><br>
 </form>
 </div> 
              <div class="section__content section__content--p30">
             <div class="container-fluid">
...
<div class="col-12 col-md-9">
    ...
    <input type="file" id="images_input" name="file"  class="form-control-file"><br>
